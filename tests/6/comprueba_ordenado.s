...
# funcion que comprueba si el vector pasado esta ordenado de forma
# estrictamente decreciente
# argumentos de entrada: $a0 direccion base del vector, $a1 num eltos
# devuelve: $v0 a 1, si está ordenado, $v0 caso contrario
ordenado:
    li $v0,1 # resultado = 1
    li $t0,0
    addi $a1,-1 # n-1
    while_ordenado: bge $t0,$a1,fin_while_ordenado
        l.d $f4,0($a0) # f4 v[i]
